from nd_robotic_ai.robot.goal.acceptance.acceptance import Acceptance
...
class Goal(ComponentGoal, BaseLeaf):
    ...
    - GoalGain is not a tangibeable concept. GoalGain is tangeable. DeliverMission or CorridorInspectionMission. But GoalGain needs tangeable points and in the environment such as GoTo point.
