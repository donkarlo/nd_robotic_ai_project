...
from nd_robotic_ai.robot.action.feedback.resource_gain.resource_gain import ResourceGain as ResourceGain
from nd_robotic_ai.robot.action.feedback.goal_gain.goal_gain import GoalGain as GoalGain
