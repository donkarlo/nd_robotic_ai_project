...
class Reminder:
    def __init__(self, yaml_action_kinds_file_path: str
                 , yaml_plan_by_date_time_file_path: str
                 , yaml_to_plan_file_path
                 ) -> None:
    ...
    def _load_yaml_file_if_exists(self, file_path) -> Optional[dict]:
        import yaml
