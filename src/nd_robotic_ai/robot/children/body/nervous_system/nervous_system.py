from nd_robotic_ai.robot.children.body.nervous_system.children.central.central import Central
from nd_robotic_ai.robot.children.body.nervous_system.children.peripheral.peripheral import Peripheral
