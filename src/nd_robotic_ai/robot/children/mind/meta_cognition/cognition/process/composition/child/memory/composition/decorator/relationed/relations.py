...
class Relations:
    def __init__(self, related_component: List[MemoryComponent]):
        """
        The idea was to define the relation between children and parent for example it is segregated for different sensory modalities but it can be used to define as any relation between this component and others
        Args:
            related_component:
        """
