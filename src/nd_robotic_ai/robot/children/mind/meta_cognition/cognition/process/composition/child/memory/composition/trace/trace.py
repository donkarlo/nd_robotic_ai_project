...
class Trace(TraceInterface):
    ...
    - trace is the connection between body's nervous_system system and mind. on one hand it receives potential activity fieelds and on theother hand it converts it to a nested action_potential_group point such as a dictionary or a children pattern
    ...
    - action_potentials can not be decorated or be children or decorated
    - trace covers from action_potential activit field to structed action_potential_group
    - this is the inner_experiment of children pattern
    """
