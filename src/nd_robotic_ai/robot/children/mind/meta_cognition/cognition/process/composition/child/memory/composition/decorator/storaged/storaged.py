# from nd_robotic_ai.structure.mind.process.children.memory.children.decorator.decorator import Decorator as CompositeMemoryDecorator
# from nd_robotic_ai.structure.mind.process.children.memory.children.trace.action_potential_group.action_potential_group import Finite as StoragedTraceGroup
...
#     """
#     TODO: Must handle bothe the internal_storage in children from which some trace groups might have derived and also all the trace groups which have internal_storage that they must and I must fix it
