...
from nd_robotic_ai.robot.composition.kind.mind.meta_cognition.cognition.process.composition.child.memory.composition.trace.group.decorator.storaged import \
    Storaged
from nd_robotic_ai.robot.composition.kind.mind.meta_cognition.cognition.process.composition.child.memory.composition.trace.group.group import Group as StoragedTraceGroup
...
class  Episode(MemoryComposite):
    ...
    - from what an episodic must be composed
        − GoalGain
        − pre_plan
        - mind environment is formed by experoceptive
    """
