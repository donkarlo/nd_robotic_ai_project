...
class Kind(ABC):
    ...
    def init_from_single_trace_kind(cls, single_trace_kind: SingleTraceKind):
        """
        Used when all members of the Finite are of the same trace parts
        Args:
            single_trace_kind:
    ...
    def set_name(self, name:str)->None:
        """
        Can be used buy others to vote for their title or currently I am using it to title it according to trace parts plus slc
        Args:
            name:
