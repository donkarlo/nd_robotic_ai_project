...
from nd_robotic_ai.robot.parts.mind.parts.cognition.parts.object_level.process.parts.memory.action.kinds.intra.segregating.kinds.slicing.kinds.by_feature.feature import Feature as FeatureSlicer
