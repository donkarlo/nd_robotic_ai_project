...
from nd_robotic_ai.robot.action.kind.suprise_reducing.suprise_reducing import SupriseReducingAction
from nd_robotic_ai.robot.parts.mind.parts.cognition.parts.object_level.process.parts.memory.parts.explicit.parts.long_term.parts.semantic.parts.goal.acceptance.kind.suprise.suprise import Suprise as SupriseAcceptance
from nd_robotic_ai.robot.parts.mind.parts.cognition.parts.object_level.process.parts.memory.parts.explicit.parts.long_term.parts.semantic.parts.goal.parts.suprise_poise.suprise_poise import SurprisePoise
...
class ModifyingSingleModalityForcastingModel(SupriseReducingAction):
    """
    ...
    def build_forcasting_modalities(self)->None:
        event_specific_knowledges = Robot().get_event_specific_knowledge_episodes()
        ...
        for esk in event_specific_knowledges:
            mixed_traces = esk.get_trace_group().get_members()
